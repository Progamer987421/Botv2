...
app.post('/bot/:id/cmd', auth, (req, res) => {
  ...
  res.json(manager.runCommand(req.params.id, cmd));
});

// GET /bot/:id/captcha — return the last captcha image for a bot
app.get('/bot/:id/captcha', auth, (req, res) => {
  res.json(manager.getCaptchaImage(req.params.id));
});
